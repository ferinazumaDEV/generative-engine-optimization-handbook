...
- **Added 2026-09-23 — a causal estimate next to the observational ones.** Agarwal & Sen's field experiment (SSRN working paper, revised 8 Jul 2026, [10.2139/ssrn.6513059](https://doi.org/10.2139/ssrn.6513059); not peer-reviewed) randomises users through a Chrome extension and finds that *"conditional on appearing, AIOs reduce outbound organic clicks by 39.8% and increase zero-click searches by 34.5%."* That is a different quantity from the SparkToro zero-click share above: an effect of the AI Overview when it appears, not a share of all searches.
- **Added 2026-09-23 — prevalence from a panel, not a keyword sample.** Comscore reports an AI Overview on **39.4%** of desktop Google searches in June 2026, up from 25.8% in July 2025 ([Comscore press release, 22 Sep 2026](https://www.comscore.com/Insights/Press-Releases/2026/9/Comscores-Q2-2026-AI-Intelligence-Report), industry-study; desktop panel (the release says "panel-based", not whether opt-in), no geography stated in the release, underlying report not opened). The Semrush figures above come from a keyword sample; the two series measure different populations and should not be spliced.
...
Added 2026-09-23: Agarwal & Sen — [SSRN 10.2139/ssrn.6513059](https://doi.org/10.2139/ssrn.6513059) (working paper) · Comscore — [Q2 2026 AI Intelligence Report press release, comscore.com](https://www.comscore.com/Insights/Press-Releases/2026/9/Comscores-Q2-2026-AI-Intelligence-Report) (industry source).
