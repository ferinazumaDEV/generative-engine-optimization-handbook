...
**Preprints logged in September 2026 (not peer-reviewed — read the caveat on each before citing):**

- *Evaluating Deep-Search Agents under Hierarchical Web Evidence Poisoning* (Bi et al., [arXiv:2609.06027](https://arxiv.org/abs/2609.06027), v1 5 Sep 2026, **v2 17 Sep 2026**). Introduces **HAE-GEO**, a benchmark that tracks what an agent does *after* exposure to manipulated content rather than only whether it was retrieved: *"Existing benchmarks largely measure whether manipulated content is retrieved or endorsed, but do not track whether an agent verifies suspicious evidence, revises adopted claims, or recovers before producing its final recommendation."* Scale: **10 agents**, **72,039 clean pages** and **770 poisoned pages per level**, three escalating attack levels, 8 product categories. Headline result, verbatim: *"evidence recognition degrades under the corroboration trap; agentic search improves final resistance without improving evidence recognition or utility; and defense prompting increases verification, yet rarely converts verification into recovery."* **Why it belongs here and not only in [08](08-future-ethics.md):** the "corroboration trap" says agents weigh *agreement across sources* above *quality of sources* — a mechanism that describes legitimate citation behaviour as much as adversarial, and one that makes the consensus mechanism in [05 · Authority](05-authority.md#mechanism-3--corroboration-and-consensus) measurable.
- *Caption Injection for Optimization in Generative Search Engine* (Chen, Bao, Wu, Chen & Liao, [arXiv:2511.04080](https://arxiv.org/abs/2511.04080), v1 6 Nov 2025 → **v4 29 Jun 2026**, marked **ECML PKDD 2026 accepted**). Proposes *"Caption Injection, the first multimodal G-SEO approach"* — extracting image captions and injecting them into text content — and reports that it *"significantly outperforms text-only G-SEO baselines"* under G-EVAL on the MRAMG benchmark. `⚠️ Logged, not endorsed. This is a rewrite heuristic measured on a benchmark, which is precisely the class C-SEO Bench challenges; and the metric is visibility within a generated response, not citation. Recorded because the paper is peer-reviewed-venue accepted, which most work in this genre is not.`

**A dated fourth block (2026-09-23) — the September 2026 literature, located and read on arXiv or in the DOI registry.** The canon sentence above is left as written; what follows is what a cluster-wide sweep on 23 Sep found, each with its status and its caveat. Peer-review status is stated per item and is what it was on that date.

- **C-SEO Bench, cited at last.** *C-SEO Bench: Does Conversational SEO Work?* ([arXiv:2506.11097](https://arxiv.org/abs/2506.11097), v3 20 Oct 2025, **NeurIPS 2025 Datasets & Benchmarks**) — two tasks, three domains each, multi-actor protocol — finds that most current C-SEO methods *"are not only largely ineffective but also frequently have a negative impact on document ranking"*, that traditional SEO that improves a source's rank in the LLM context is significantly more effective, and that overall gains decrease as more actors adopt C-SEO. This is the paper the caveats on the rewrite-heuristic preprints above refer to.
- **The SIGIR paper has a proceedings DOI.** *What Gets Cited* (Part 2 above) is registered as [10.1145/3805712.3808445](https://doi.org/10.1145/3805712.3808445), Proceedings of the 49th ACM SIGIR, Crossref published-online 2026-07-19 — cite the DOI, not only the arXiv id.
- **Counter-GEO-Bench** ([arXiv:2609.02316](https://arxiv.org/abs/2609.02316), 2 Sep 2026, accepted **EMNLP 2026 main**): 247 human-verified queries, three victim LLMs; three off-the-shelf guardrails cut the attack success rate of information-distorting GEO rewrites by at most 5.7% relative, because the rewrites pass as fluent informational content; the proposed C-GEO Guard cuts it 47.6% relative.
- **GEO Defender** ([arXiv:2609.02964](https://arxiv.org/abs/2609.02964), 2 Sep 2026, preprint): a shield reranker plus a training-free experience library reduces the average success of seven GEO attacks from 50.32% to 6.20% while keeping 94.12% of benign-evidence use; the authors note attack documents stay factually consistent with their originals, which is why fact-checking and perplexity filters fail.
- **Answer Bubbles** ([arXiv:2603.16138](https://arxiv.org/abs/2603.16138), v2 28 Aug 2026, **EMNLP 2026**): across 11,000 real queries on five systems, generative search over-represents Wikipedia and longer sources and under-represents social media and negatively framed sources; adding search reduces hedging by up to 60%.
- **CITECHOICE** ([arXiv:2609.15164](https://arxiv.org/abs/2609.15164), 14 Sep 2026, preprint): in a hash-verified 2×2 replay of 103 same-fact document pairs, structured rendering raises the target's citation count by +0.50 per answer without raising total citations; the incidence effect (+4.5 pp) is inconclusive; the observational rank-1 vs rank-5 gap of 42.3 pp shrinks to +7.9 pp under controlled reordering; 15% of binary decisions flip under fresh decoding. The last two numbers are the ones to remember when reading any correlational rank study in Part 3.
- **Product-recommendation audit** ([arXiv:2609.18729](https://arxiv.org/abs/2609.18729), 16 Sep 2026, preprint): across 1,536 product-query responses, the ChatGPT and Gemini interfaces share only 5.4% of displayed source domains on average, and each vendor's API shows a different source view from its own interface (mean domain overlap 12.0% ChatGPT, 14.8% Gemini). An API-based panel is not measuring what users see.
- **Cross-lingual audits.** *Auditing Source Exposure in Baidu and Google AI Search* ([arXiv:2609.24407](https://arxiv.org/abs/2609.24407), 21 Sep 2026, accepted WAC @ EMNLP 2026): low overlap in visible host-domain inventories across platform-language settings, matched-query answers at median cosine similarity 0.701–0.813. *Who Anchors AI Overviews in Health?* ([arXiv:2609.06798](https://arxiv.org/abs/2609.06798), 6 Sep 2026, preprint): 1,920 health queries across 12 countries and 4 languages; asking in the country's official language rather than English raises the share of locally sourced citations roughly 3.5- to 13.5-fold. *Sources of Truth* ([arXiv:2609.00319](https://arxiv.org/abs/2609.00319), 31 Aug 2026, under review): 15,942 citations across 1,140 mental-health responses; the ten most-cited domains take 43.6% of English citations and non-English queries surface fewer citations. Together these are the first locale evidence this handbook has; chapters 03 and 06 do not yet act on it.
- **Two more field experiments on publisher traffic.** Agarwal & Sen, *The Impact of Google AI Overviews on Publisher Traffic and User Experience: Evidence from a Field Experiment* (SSRN working paper, posted 3 Apr 2026, revised 8 Jul 2026, [10.2139/ssrn.6513059](https://doi.org/10.2139/ssrn.6513059); not peer-reviewed): users randomised via a Chrome extension; *"conditional on appearing, AIOs reduce outbound organic clicks by 39.8% and increase zero-click searches by 34.5%, without affecting sponsored clicks or overall search frequency."* This resolves the W39 watching item (DCN's 404 post); SSRN returned 403 to automated clients and the abstract was read through the Internet Archive raw mirror (snapshot 2026-09-15), the DOI confirmed via Crossref. *AI in Search Reduces Publisher Referrals Without Improving User Experience* ([arXiv:2608.18352](https://arxiv.org/abs/2608.18352), 18 Aug 2026, preprint): a preregistered experiment (N = 1,100) finds removing AI Overviews and AI Mode raises click-through to publishers, and an AI Mode-only experience lowers it and erodes trust.
- **Two critical surveys, no new experiments.** *Optimizing Visibility in Generative Engines* ([arXiv:2607.14035](https://arxiv.org/abs/2607.14035), 15 Jul 2026, preprint) reviews 45 studies (Nov 2023–Jul 2026) and concludes topical relevance and context position are the most reproducible levers, that the founding paper's gains are conditional on a source already being in a fixed context, and that no reviewed technique shows a stable, longitudinal, cross-platform causal effect. *Measuring GEO Visibility: Prompt Corpora Define the Answer Market* ([arXiv:2609.06811](https://arxiv.org/abs/2609.06811), 6 Sep 2026, preprint) argues a visibility score's prompt corpus and weights define an "answer market" that need not represent demand, that an LLM scorer's instruction can move the score of an unchanged answer, and that a citation alone does not establish contribution.
- **Industry, logged as such.** *From Prompt to Recommendation* ([arXiv:2609.23162](https://arxiv.org/abs/2609.23162), 19 Sep 2026; 34,960 observations from 75 projects of one GEO vendor, GPT and Gemini, June–September 2026): target mention rates of 2.8%/3.8% with neither brand nor own domain in the observable retrieval path, 49.0%/58.4% with an own-domain citation, 91.4%/100% with both; the authors state the model is predictive and observational, not causal. *From Ranked Documents to Reliable Contexts* ([arXiv:2609.23354](https://arxiv.org/abs/2609.23354), v1 20 Sep 2026 → v2 22 Sep 2026, industrial): frames context construction as answer support, content trustworthiness (source, temporal, factual) and organisation under a finite context budget — a vendor's description of the gate a page must pass, useful as a checklist, not as evidence.
- **Jaccard, re-read (resolves the `needs verification` on [CLAIMS.md](../CLAIMS.md) row 12).** *Don't Measure Once* ([arXiv:2604.07585](https://arxiv.org/html/2604.07585), v1 8 Apr 2026, preprint) reports day-to-day Jaccard similarity of cited sources of 0.336–0.423 by campaign (Table 2) and repeated-run Jaccard within 24 hours of 0.321–0.434 (Table 4, stated in the text as "between 0.32 and 0.43"); the quoted ≈0.32–0.43 range is Table 4.

**Vendor and agency studies logged in September 2026 (industry work — weight per Part 3):**

- **Ahrefs, *AI Overviews cut CTR by 23.1% in France*** (16 Sep 2026, [ahrefs.com](https://ahrefs.com/blog/ai-overviews-france-impact/)). Takes the 1,000 domains generating the most clicks in France (963 usable) and compares aggregated Search Console data for **28 days before** and **9 days after** the 22 Jul 2026 French launch of AI Overviews — a **natural-experiment** design rather than the correlational comparisons that dominate this genre. Headline, verbatim: *"For the domains most exposed to AI Overviews, it fell 23.1%. Six times as much."* More useful than the headline is the gradient it reports — roughly **one point of CTR lost per extra point of AI Overview exposure** — which converts a market-level claim into a per-site estimate you can compute from your own exposure rate. It also records the impressions/clicks decoupling, with one case at **+183% impressions for −1.9% clicks**. `⚠️ Vendor study; observational before/after with a 9-day post-period, which is its main weakness — a single short window cannot separate the launch from seasonality.`

- *Scoring Without the Engine: Validating a Deterministic, Manipulation-Resistant Content Score for Generative Engines, End to End* (Bajemon & Rochet, [arXiv:2609.07559](https://arxiv.org/abs/2609.07559), 7 Sep 2026). Validates a content-only quality score with adversarial falsification gates across *"ten modern engine families"* and a 500-source benchmark of adversarial edits. The numbers that matter here: amplifying the score's levers *"gains an attacker at most 6 points"*; citation prediction reaches only *"within-query Spearman 0.11"*; and *"re-measuring the only published causal anchors (2023 effect sizes) on ten modern engine families shows their levers move citation on none."* That last line is direct evidence for this chapter's own caveat that the founding paper's magnitudes are era-specific. `⚠️ vendor-affiliated (the comments field links Citead.com); code and data are published; not replicated.`
- *Q2D-Web: A Large-Scale Benchmark for Retrieval in Agentic RAG Systems* (Schall et al., [arXiv:2609.08887](https://arxiv.org/abs/2609.08887), 8 Sep 2026; announced by Perplexity on 9 Sep). A 190M-document corpus, 70k agent-reformulated queries in ten languages, and relevance judgments that include **agent citations** — see [02 · The Engines](02-engines.md#perplexity). Vendor-released; useful mainly as a public testbed for the retrieved-vs-cited distinction.
- *Generative Marketing Mix Modeling: A Causal Inference Framework Linking GEO and GEM to Business Impact* (Kato, Honma & Kato, [arXiv:2609.11915](https://arxiv.org/abs/2609.11915), 10 Sep 2026). A causal attribution framework that puts organic AI-answer presence (GEO) and sponsored placements ("GEM") in the same ledger as classic channels. **Validated only on simulated answers** — a method to borrow, not a data point to cite.
...
**Added 2026-09-23 (cluster review) — see the dated fourth block in Part 2 for status and caveats:**

- Vishwakarma, Kumar & Jamidar — *What Gets Cited*, SIGIR 2026 — [doi:10.1145/3805712.3808445](https://doi.org/10.1145/3805712.3808445)
- *C-SEO Bench* — [arXiv:2506.11097](https://arxiv.org/abs/2506.11097) (NeurIPS 2025 D&B)
- *Counter-GEO-Bench* — [arXiv:2609.02316](https://arxiv.org/abs/2609.02316) (EMNLP 2026) · *GEO Defender* — [arXiv:2609.02964](https://arxiv.org/abs/2609.02964)
- *Answer Bubbles* — [arXiv:2603.16138](https://arxiv.org/abs/2603.16138) (EMNLP 2026) · *CITECHOICE* — [arXiv:2609.15164](https://arxiv.org/abs/2609.15164) · product-recommendation audit — [arXiv:2609.18729](https://arxiv.org/abs/2609.18729)
- Cross-lingual audits — [arXiv:2609.24407](https://arxiv.org/abs/2609.24407) · [arXiv:2609.06798](https://arxiv.org/abs/2609.06798) · [arXiv:2609.00319](https://arxiv.org/abs/2609.00319)
- Agarwal & Sen — SSRN working paper [doi:10.2139/ssrn.6513059](https://doi.org/10.2139/ssrn.6513059) · [arXiv:2608.18352](https://arxiv.org/abs/2608.18352)
- Surveys — [arXiv:2607.14035](https://arxiv.org/abs/2607.14035) · [arXiv:2609.06811](https://arxiv.org/abs/2609.06811)
- Industry — [arXiv:2609.23162](https://arxiv.org/abs/2609.23162) · [arXiv:2609.23354](https://arxiv.org/abs/2609.23354)
- *Don't Measure Once* — [arXiv:2604.07585](https://arxiv.org/html/2604.07585)
...
- **Similarweb (2025). *2025 Generative AI Landscape.*** — AI prompts ~17× longer than Google searches: *"The average ChatGPT prompt runs about 60 words; the average Google search runs 3.4, according to Similareweb's* [sic] *2025 Generative AI Landscape report."* First-party statement: [Similarweb, "How to do prompt research for AI SEO", 2026-05-05](https://aisearch.similarweb.com/blog/prompt-research/); the report it cites is a gated download ([*From Platforms to Pathways: Gen AI Journeys in 2025*](https://www.similarweb.com/corp/reports/2025-generative-ai-landscape/)); secondary coverage: [OfficeChai](https://officechai.com/ai/chatgpt-queries-17x-longer-than-google-searches-6x-longer-than-googles-ai-mode-similarweb-data/). `⚠️ partial: the figure is first-party, but the report is not publicly readable — cite the blog post, not the report`
