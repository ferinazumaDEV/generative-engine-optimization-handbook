...
- **Similarweb (2025). *2025 Generative AI Landscape.*** — AI prompts ~17× longer than Google searches: *"The average ChatGPT prompt runs about 60 words; the average Google search runs 3.4, according to Similarweb's 2025 Generative AI Landscape report."* First-party statement: [Similarweb, "How to do prompt research for AI SEO", 2026-05-05](https://aisearch.similarweb.com/blog/prompt-research/); secondary coverage: [OfficeChai](https://officechai.com/ai/chatgpt-queries-17x-longer-than-google-searches-6x-longer-than-googles-ai-mode-similarweb-data/). `⚠️ partial: the figure is now first-party, but the report page itself has not been located — cite the blog post, not the report`
