...
> **The bargain gets a price tag (added 2026-09-21).** On **14 Sep 2026** Google began testing direct payment to publishers whose content grounds its AI answers — the **"AI contribution pilot"**, surfaced as an earnings widget inside Search Console and covering the **Gemini app, AI Overviews and AI Mode**. The Search Console panel reads *"Accumulate earnings when your content contributes significantly to AI-generated responses in participating products"*, and the eligibility rule is a **generation-stage** one: Google's help text says *"Web content may also confirm facts or be linked to within Google's AI after a response is generated, but those instances don't qualify for AI contribution."* Google trailed the idea in June 2026 as *"piloting a new way to partner with websites whose content meaningfully contributes to the freshness and factuality of generative AI responses"*, and described this pilot as an early-stage learning test of how best to reward high-quality content. Reported scope is at least dozens of publishers, skewing small and mid-sized, reaching beyond news ([Digiday, 14 Sep 2026](https://digiday.com/media/google-rolls-out-pay-value-ai-licensing-program-to-publishers/) · [Search Engine Journal, 14 Sep 2026](https://www.searchenginejournal.com/google-tests-paying-publishers-for-ai-answers-via-search-console/589414/) · [9to5Google, 17 Sep 2026](https://9to5google.com/2026/09/17/google-ai-contribution-pilot-tests-paying-websites-when-theyre-used-in-ai-results/)).
>
> **Why this matters more than its size.** It is the first time the broken half of the bargain has been answered with money rather than with links, and the payout rule draws exactly the distinction this handbook draws throughout: **grounding an answer is a different act from being linked beside one**, and Google is now paying for the first and explicitly not for the second. That converts an editorial argument into an accounting one.
>
> `⚠️ needs-verification: no first-party Google help page for the pilot was retrievable, so every quotation of Google's wording above is a third-party reproduction. Google has published no rate, formula or participant count, and participants quoted in the reporting describe early payouts as small. Treat any circulating amount as anecdote.`
...
- **What the agent does *after* it is fooled (2026-09-21).** HAE-GEO measures the full trajectory rather than the hit: *"evidence recognition degrades under the corroboration trap; agentic search improves final resistance without improving evidence recognition or utility; and defense prompting increases verification, yet rarely converts verification into recovery"* (Bi et al., [arXiv:2609.06027](https://arxiv.org/abs/2609.06027) v2, 17 Sep 2026; 10 agents, 72,039 clean and 770 poisoned pages per level). Two uncomfortable implications for anyone hoping defences will solve this: agentic search makes the *final answer* more resistant **without** making the agent better at spotting bad evidence, and telling a model to be careful makes it *check* more without making it *recover* more. The **corroboration trap** — agents weighting agreement across sources above the quality of those sources — is also why coordinated low-quality repetition is a live attack, and why the honest version of this handbook's advice is corroboration you actually earn.
...
- The **EU AI Act, Article 50** requires providers to **mark AI-generated synthetic content (audio, image, video, *text*) in a machine-readable, detectable format**, and requires deployers to **disclose AI-generated text published to inform the public on matters of public interest** — unless it had human editorial review with a responsible editor ([EU AI Act Art. 50](https://artificialintelligenceact.eu/article/50/)). **Application date: 2 August 2026**, in application now. The Act's implementation timeline states that on that date *"the remainder of the AI Act starts to apply, unless specified otherwise"* ([timeline](https://artificialintelligenceact.eu/implementation-timeline/)), and Article 113 specifies nothing separate for Chapter IV, where Article 50 sits ([Art. 113](https://artificialintelligenceact.eu/article/113/); Official Journal text: [Regulation (EU) 2024/1689](https://data.europa.eu/eli/reg/2024/1689/oj)). One carve-out on that timeline: providers of systems generating synthetic audio, image, video or text that were placed on the market *before* 2 August 2026 have until **2 December 2026** to comply with Article 50(2), the machine-readable marking. `⚠️ How it is enforced in practice — guidance, codes of practice, national authorities — is still settling; that part needs verification against current guidance.`
